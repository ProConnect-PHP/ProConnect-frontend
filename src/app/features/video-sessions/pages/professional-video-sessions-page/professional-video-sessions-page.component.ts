...
@Component({
  selector: 'app-professional-video-sessions-page',
  imports: [
    RouterLink,
    AppAlertComponent,
  ...
  templateUrl: './professional-video-sessions-page.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProfessionalVideoSessionsPageComponent implements OnInit {
  ...
  loadVideoSessions(page = this.page()): void {
    ...
    this.api
      .listProfessionalVideoSessions({ page, per_page: this.perPage })
      .pipe(
  ...
  viewBooking(videoSession: VideoSession): void {
    void this.router.navigate(['/professional/bookings', videoSession.booking_id]);
  }
